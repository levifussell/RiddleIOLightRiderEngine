...
< fifo0 stdbuf -o0 ./Engine/run.out p 100 | tee fifo1 fifo2 &
stdbuf -o0 java -cp Bots/JavaBots LeviFuBot 2 > fifo0 < fifo1 & #GREEN
stdbuf -o0 java -cp Bots/JavaBots LeviFuBot 3 > fifo0 < fifo2 #RED
